      ...
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 flex-1 min-w-0">
          <button
            ...
            style={{ display:'flex', alignItems:'center', gap:8, background:'none', border:'none', cursor:'pointer', marginRight:12, flexShrink:0 }}
          >
            <div style={{
          ...
          {user ? (
            <div style={{ position:'relative' }}>
              <button
                ...
                style={{
                  ...
                  borderRadius:8, padding:'5px 12px', cursor:'pointer', color:'#4a9eff',
                  fontSize:13, fontWeight:600, fontFamily:'Noto Sans KR',
                }}
              >
                <span style={{
              ...
              {showUserMenu && (
                <div style={{
                  ...
                  borderRadius:10, padding:6, minWidth:130, zIndex:999,
                  boxShadow:'0 8px 24px rgba(0,0,0,0.5)',
                }}>
                  <button onClick={() => { logout(); setShowUserMenu(false); }} style={{
                    width:'100%', textAlign:'left', padding:'8px 12px',
                    background:'transparent', border:'none', color:'#ff4757',
                    fontSize:13, cursor:'pointer', borderRadius:6, fontFamily:'Noto Sans KR',
                  }}
            ...
            <button
              ...
              style={{
                ...
                cursor:'pointer', fontFamily:'Noto Sans KR', transition:'opacity 0.2s',
              }}
